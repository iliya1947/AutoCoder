...
29 августа 2026 (исправлен regression Project switch, найденный на 50% acceptance).
...
### Project switch regression на барьере 50% (29 августа 2026)
...
- Добавлены frontend regression-тесты совместного отображения дерева и ошибки и границы session id,
  а также Rust-тест повторного открытия текущего root при активной Terminal-команде. Автоматические
  проверки пройдены; исправленный packaged flow требует точечного повторного Windows-прогона, поэтому
  50% acceptance пока имеет статус **RECHECK REQUIRED**, а не PASS.
...
- следующий шаг следует выбирать после новой точечной ревизии оставшегося MVP flow;
