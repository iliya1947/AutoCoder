...
- завершить следующий шаг вертикального сценария: безопасно открыть выбранный текстовый файл из дерева через Tauri-команду;
- после появления открытия текстового файла подключить Monaco Editor для редактирования и сохранения открытого файла;
