...
- расширение File Tool на создание и удаление файлов;
- Terminal Tool;
...
1. File Tool пока изменяет только открытый файл; создание и удаление файлов ещё не реализованы.
2. Управление и восстановление созданных backup-копий отсутствуют; атомарная запись теперь защищает целевой файл от частичной записи при сбое.
