...
29 августа 2026 (три негативных сценария Ollama подтверждены на packaged Windows; Chat-сессия изолирована при смене проекта).
...
- вручную подтвердить на packaged Windows, что после открытия другого проекта Chat очищает сообщения и предложения предыдущего проекта, а отмена выбора проекта сохраняет текущую сессию;
...
Основной `Doc/WINDOWS_CHAT_CHECKLIST.md`, Backup Manager, Terminal Tool, AI → Terminal review, Terminal → Chat review и три негативных diagnostic scenarios Ollama успешно подтверждены пользователем на packaged Windows-сборке. Следующим техническим шагом выполнена изоляция Chat-сессии при смене проекта; ближайшая проверка — packaged Windows regression этого поведения.
