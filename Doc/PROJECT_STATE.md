...
- реализовать первый вертикальный сценарий «открыть проект → показать файлы → открыть текстовый файл» через безопасные Tauri-команды;
- после появления этого сценария подключить Monaco Editor для редактирования и сохранения открытого файла;
