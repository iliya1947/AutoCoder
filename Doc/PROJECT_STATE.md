...
29 августа 2026 (полный Terminal → Chat review flow подтверждён на packaged Windows).
...
- отдельно проверить в packaged Windows диагностику отсутствующего `ollama.exe`, отсутствующей модели и HTTP 503 readiness по готовому `Doc/WINDOWS_CHAT_CHECKLIST.md`;
