...
28 августа 2026 (обновлено после исправления границы истории AI Chat).
...
Следующий шаг — проверить чат, предложение замены, построчный diff и сброс отправляемой истории после изменения файла с реальным Ollama/Tauri на Windows. Не расширять File Tool на создание или удаление файлов до проверки безопасного цикла предложения и подтверждения.
