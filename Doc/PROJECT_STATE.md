...
29 августа 2026 (устранено принятие устаревшего AI-ответа после смены контекста).
...
- stale Save в packaged Windows подтверждён со статусом **PASS** и больше не является следующим
  обязательным шагом;
- устаревшие AI-ответы при изменении editor/project context отбрасываются; следующий шаг следует
  выбирать после новой точечной ревизии оставшегося MVP flow;
