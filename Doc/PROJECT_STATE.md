...
- Добавлен конкурентный Rust regression, сто раз одновременно запускающий команду и смену проекта и проверяющий сам инвариант root/switch result, а не только состояние helper. Автоматические проверки выполнены в Linux; точное сообщение блокировки и повторный выбор после Cancel остаются ближайшим packaged Windows regression.
